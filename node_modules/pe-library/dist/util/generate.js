...
var ImageFileHeader_1 = require("../format/ImageFileHeader");
var ImageNtHeaders_1 = require("../format/ImageNtHeaders");
var ImageOptionalHeader_1 = require("../format/ImageOptionalHeader");
var ImageOptionalHeader64_1 = require("../format/ImageOptionalHeader64");
...
var DOS_STUB_SIZE = functions_1.roundUp(ImageDosHeader_1.default.size + DOS_STUB_PROGRAM.length, 0x80);
...
function fillDosStubData(bin) {
    var dos = ImageDosHeader_1.default.from(bin);
    dos.magic = ImageDosHeader_1.default.DEFAULT_MAGIC;
    // last page size
    ...
    dos.headerSizeInParagraph = Math.ceil(ImageDosHeader_1.default.size / 16);
    dos.minAllocParagraphs = 0;
    dos.maxAllocParagraphs = 0xffff;
    dos.initialSS = 0;
    dos.initialSP = 0x80;
    // (no relocations, but set offset after the header)
    dos.relocationTableAddress = ImageDosHeader_1.default.size;
    dos.newHeaderAddress = DOS_STUB_SIZE;
    functions_1.copyBuffer(bin, ImageDosHeader_1.default.size, DOS_STUB_PROGRAM, 0, DOS_STUB_PROGRAM.length);
}
...
function estimateNewHeaderSize(is32Bit) {
    ...
    // magic
    4 +
        ImageFileHeader_1.default.size +
        (is32Bit ? ImageOptionalHeader_1.default.size : ImageOptionalHeader64_1.default.size) +
        ImageDataDirectoryArray_1.default.size);
}
...
function fillPeHeaderEmptyData(bin, offset, totalBinSize, is32Bit, isDLL) {
    ...
    new DataView(_bin, _offset).setUint32(0, ImageNtHeaders_1.default.DEFAULT_SIGNATURE, true);
    var fh = ImageFileHeader_1.default.from(_bin, _offset + 4);
    ...
    var oh = (is32Bit ? ImageOptionalHeader_1.default : ImageOptionalHeader64_1.default).from(_bin, _offset + 4 + ImageFileHeader_1.default.size);
    oh.magic = is32Bit
        ? ImageOptionalHeader_1.default.DEFAULT_MAGIC
        : ImageOptionalHeader64_1.default.DEFAULT_MAGIC;
    ...
    oh.sizeOfHeaders = functions_1.roundUp(totalBinSize, oh.fileAlignment);
    // oh.checkSum = 0;
    ...
    oh.numberOfRvaAndSizes =
        ImageDataDirectoryArray_1.default.size / ImageDataDirectoryArray_1.default.itemSize;
}
exports.fillPeHeaderEmptyData = fillPeHeaderEmptyData;
function makeEmptyNtExecutableBinary(is32Bit, isDLL) {
    var bufferSize = functions_1.roundUp(DOS_STUB_SIZE + estimateNewHeaderSize(is32Bit), DEFAULT_FILE_ALIGNMENT);
